...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<ErroCustomizado> entidadeNaoEncontrada(EntityNotFoundException e, HttpServletRequest request) {
        ...
        erro.setMessage(e.getMessage()); // A mensagem que colocamos no Service ("Livro não encontrado...")
    ...
    public ResponseEntity<ErroCustomizado> validacao(MethodArgumentNotValidException e, HttpServletRequest request) {
        ...
        // Usamos o status 422 (Unprocessable Entity) que é muito usado para erros de validação
        ...
        // Aqui a mágica: pegamos a lista de erros que o Spring gerou e passamos para o nosso JSON limpo
